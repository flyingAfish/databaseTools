 ...
 */
public class ParameterTool extends Properties implements Serializable {
     ...
     * Returns {@link ParameterTool} for the given {@link Properties} file.
     *
     * @param path Path object to the properties path
     * @return A {@link ParameterTool}
     * @throws IOException If the file does not exist
     * @see Properties
     */
    public static ParameterTool fromPropertiesPath(Path path) throws IOException {
        return fromPropertiesFile(path.toFile());
    }

    /**
     * Returns {@link ParameterTool} for the given {@link Properties} file.
     *
     * @param1 first the path string or initial part of the path string
     * @param2 more additional strings to be joined to form the path string
     * @return A {@link ParameterTool}
     * @throws IOException If the file does not exist
     * @see Properties
     */
    public static ParameterTool fromPropertiesPaths(String first, String... more) throws IOException {
        return fromPropertiesPath(Paths.get(first, more));
    }
